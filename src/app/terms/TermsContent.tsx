    ...
    <>
      ...
      <div style={sectionStyle}>
        ...
        <ul style={listStyle}>
          ...
          <li style={liStyle}>בנוסף, נדרש אימות מספר טלפון נייד באמצעות קוד חד-פעמי (OTP) הנשלח ב-SMS. מספר הטלפון משמש לזיהוי ולמניעת שימוש כפול, ונמחק אוטומטית לאחר סיום האירוע.</li>
      ...
      <div style={sectionStyle}>
        ...
        <ul style={listStyle}>
          <li style={liStyle}>אימות זהות באמצעות קוד SMS חד-פעמי למספר הנייד</li>
          ...
          <li style={liStyle}>קבלת הודעות WhatsApp מהמערכת (הזמנה לאירוע, פידבק), בכפוף להסכמת המשתמש/ת</li>
        </ul>
        <p style={boldText}>
      ...
      <div style={sectionStyle}>
        ...
        <ul style={listStyle}>
          ...
          <li style={liStyle}><strong>SMS</strong> - לצורך שליחת קוד אימות (OTP) למספר הנייד שלך.</li>
        </ul>
        <p style={textStyle}>

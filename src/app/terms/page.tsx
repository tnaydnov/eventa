    ...
    <LegalPageLayout title="תנאי שימוש" updatedAt="פברואר 2026">
      ...
      <div style={sectionStyle}>
        ...
        <ul style={listStyle}>
          ...
          <li style={liStyle}>לא לאסוף מידע על אחרים (כולל צילום / הקלטה / העתקה / הפצה) ללא רשותם</li>
        </ul>
        <p style={boldText}>
      ...
      <div style={sectionStyle}>
        ...
        <ul style={listStyle}>
          <li style={liStyle}>כל תוכן שהמשתמש/ת מעלה או שולח/ת (טקסט, תמונות, קול) הוא באחריותו/ה הבלעדית.</li>
          <li style={liStyle}>
      ...
      {/* 9 */}
      <div style={sectionStyle}>
        <h2 style={headingStyle}>9. דיווח על הטרדה / תוכן פוגעני (&quot;Report&quot;)</h2>
        <p style={textStyle}>
          השירות עשוי לאפשר דיווח על משתמשים או תוכן.
        </p>
        <ul style={listStyle}>
          ...
          <li style={liStyle}>המפעיל אינו מתחייב לטיפול בזמן אמת או לתגובה מיידית, אך ישתדל לטפל בדיווחים בפרק זמן סביר.</li>
        </ul>
      </div>

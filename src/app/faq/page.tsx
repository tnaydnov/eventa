...
const categories: FaqCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'האורחים סורקים QR או לוחצים על קישור (אם בחרתם לשלוח הודעות WhatsApp, הם מקבלים קישור אישי ישירות). הם מזינים מספר טלפון, מקבלים קוד אימות SMS, בונים פרופיל - וזהו.',
      },
      {
    ...
    items: [
      {
        ...
        a: 'ממלאים את הפרטים באתר, משלמים באשראי או BIT, ומקבלים פוסטר מעוצב עם QR כקובץ דיגיטלי - וזהו. הכל אונליין, בלי המתנה.',
      },
      {
        q: 'איך משלמים?',
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: 'מה זה שליחת הודעות WhatsApp?',
        a: 'בתהליך ההזמנה אפשר לבחור לשלוח הודעות WhatsApp לאורחים. מעלים רשימת טלפונים (Excel) ואנחנו שולחים לכל אורח הודעה עם קישור אישי להצטרפות - עוד לפני האירוע.',
      },
      {

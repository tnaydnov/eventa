        ...
        <div className="hps hps--wa">
          ...
          <div className="hps__wa-chat">
            <div className="hps__wa-bubble">
              <p>מגיעים לחתונה? את/ה רווק/ה? 💍</p>
              <p>הם מצאו את אהבתם, עכשיו תורכם! ❤️</p>
              <p>באירוע תהיה לכם הזדמנות להצטרף לאפליקציית <strong>Eventa</strong> - ולראות את שאר הרווקים והרווקות שיהיו שם.</p>
              <p>אל תדאגו - זו אפליקציה ייעודית רק לאירוע זה, וכל הנתונים שלכם יימחקו כשבוע לאחר האירוע. 🔒</p>
              <p>כדאי לכם להיכנס כבר עכשיו ולבדוק את השטח…{'\n'}אולי תשיגו משהו מעניין 😏</p>
              <p className="hps__wa-link">🔗 קישור להצטרפות לאירוע</p>
            </div>
          </div>
          <p className="hps__wa-note">* התוכן המדויק עשוי להשתנות מעט</p>
        </div>
      );
    case 'org-place':
      return (

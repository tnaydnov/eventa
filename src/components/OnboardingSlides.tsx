...
const SLIDES: Slide[] = [
  {
    icon: '⏱',
    title: 'זמין רק לזמן מוגבל',
    body: 'Eventa פעילה סביב האירוע ונמחקת אוטומטית לאחר 7 ימים.',
  },
  {
    icon: '✏️',
    title: 'הפרופיל בשליטתך',
    body: 'אפשר לערוך או למחוק את הפרופיל בכל שלב.',
  },
  {
    icon: '🚫',
    title: 'חוויה בטוחה יותר',
    body: 'אפשר לחסום משתמשים ולדווח על תוכן לא מתאים.',
  },
];
